# app/frameworks_drivers/orm/models_auth.py
...
class UsuarioModel(Base):
    ...
    email: Mapped[str] = sa.Column(sa.Text, nullable=False, unique=True)  # en PG usas citext
    ...
    # IMPORTANTE en async: evitar lazy por defecto -> selectin
...
class UserIdentityModel(Base):
    ...
    provider: Mapped[str] = sa.Column(sa.Text, nullable=False)            # 'google'
    provider_user_id: Mapped[str] = sa.Column(sa.Text, nullable=False)    # sub
