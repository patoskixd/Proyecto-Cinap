...
import type { Advisor, AdvisorServiceRef, CategoryId } from "@/domain/adminAdvisors";
  ...
  return (
    <div className={`group relative overflow-hidden rounded-3xl border transition-all duration-500 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl ${
      ...
      <div className="absolute right-4 top-4 flex gap-2">
        <div className={`h-2 w-2 rounded-full shadow-sm ${advisor.active ? 'bg-gradient-to-r from-green-400 to-green-500 animate-pulse' : 'bg-gradient-to-r from-red-400 to-red-500'}`} />
        {!advisor.active && (
