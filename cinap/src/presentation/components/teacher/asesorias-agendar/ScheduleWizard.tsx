...
const Step3 = () => {
  ...
  // Si luego vienen del backend, reemplaza estos labels:
  const locationLabel = "Edificio CT — Piso 4, Campus Central";
  const roomLabel = "CT-428";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="w-full max-w-xl mx-auto lg:col-span-2 rounded-2xl border-2 border-slate-200 bg-slate-50 p-6">
          ...
          <dl className="divide-y divide-slate-200">
            ...
            {/* NUEVO: Ubicación */}
            <div className="flex items-center justify-between py-3">
              <dt className="text-sm font-medium text-neutral-700">Ubicación</dt>
              <dd className="text-sm font-semibold text-neutral-900">{locationLabel}</dd>
            </div>

            {/* NUEVO: Sala */}
            <div className="flex items-center justify-between py-3">
              <dt className="text-sm font-medium text-neutral-700">Sala</dt>
              <dd className="text-sm font-semibold text-neutral-900">{roomLabel}</dd>
            </div>
          </dl>
        </div>
      </div>
