    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl border border-white/30 bg-white/70 shadow-2xl backdrop-blur-xl">
          <div className="relative h-40 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200" />
...
export default function ProfileScreen({ initialProfile }: { initialProfile: ProfileSummary | null }) {
  ...
  const isTeacher = data?.user?.role?.toLowerCase() === 'profesor' || data?.user?.role?.toLowerCase() === 'teacher';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          {/* Banner superior */}
          <div className="h-32 bg-gradient-to-r from-blue-50 to-blue-100 relative border-b border-blue-200">
            <div className="absolute -bottom-16 left-8">
              <div className={`w-32 h-32 rounded-full shadow-xl border-4 border-white flex items-center justify-center ${
                isTeacher 
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-blue-100/80 backdrop-blur-sm border border-blue-200/50 text-blue-700 shadow-md">
                  ...
                  {user.role.toLowerCase() !== 'admin' && (
                    <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium shadow-md transition-all duration-300 ${
                      tg.linked 
                        ? 'bg-green-100/80 backdrop-blur-sm border border-green-200/50 text-green-700' 
                        : 'bg-gray-100/80 backdrop-blur-sm border border-gray-200/50 text-gray-700'
                    }`}>
              ...
              {user.role.toLowerCase() !== 'admin' && (
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold shadow-md transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-60 bg-blue-100/80 backdrop-blur-sm border border-blue-200/50 text-blue-700 hover:bg-blue-200/80 hover:shadow-lg"
                  >
                  ...
                  {tg.linked && (
                    <button
                      ...
                      onClick={unlink}
                      disabled={busy}
                      className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold shadow-md transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-60 bg-red-100/80 backdrop-blur-sm border border-red-200/50 text-red-700 hover:bg-red-200/80 hover:shadow-lg"
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 transition-all duration-300 hover:shadow-2xl hover:scale-105">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-gradient-to-br from-yellow-400 via-yellow-500 to-amber-600 rounded-2xl shadow-lg">
          ...
          <div className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-8 transition-all duration-300 hover:shadow-2xl hover:scale-105">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-2xl shadow-lg">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              </div>
