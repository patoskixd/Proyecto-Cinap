        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <div className="mt-2 flex items-center gap-3 text-sm">
              ...
              <span className="px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">Verificado</span>
            </div>
          ...
          <button
            type="button"
            className="group relative overflow-hidden rounded-full border-2 border-sky-400 px-5 py-2.5 text-sky-700
