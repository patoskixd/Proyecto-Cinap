...
export default function GuiasSection() {
  return (
    <section id="guias-rapidas" className="mb-16 scroll-mt-24">
          ...
          <div className="flex-1">
            ...
            <ol className="space-y-2.5 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>Inicia sesión con tu cuenta institucional de Google para acceder de forma segura al sistema.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Desde tu panel principal, selecciona “Agendar asesoría” o utiliza el asistente virtual integrado.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Selecciona la categoría, el servicio y el asesor que correspondan a tu requerimiento.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Escoge la fecha y el horario disponibles según tu conveniencia.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Confirma la reserva. Recibirás un correo electrónico con los detalles de la asesoría.</span>
              </li>
            </ol>
          </div>
        </div>
      ...
      {/* Guía 2: Gestionar tus Asesorías */}
          ...
          <div className="flex-1">
            ...
            <ol className="space-y-2.5 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>Desde el panel principal, selecciona la opción “Ver todas las asesorías”.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Utiliza las pestañas “Próximas” e “Historial” para revisar tus asesorías pendientes, confirmadas o finalizadas.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Desde cada tarjeta, selecciona “Confirmar” o “Cancelar” según tu disponibilidad.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>También puedes confirmar tu asistencia desde el correo o Google Calendar.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>El sistema actualiza los estados automáticamente: las asesorías confirmadas se registran como “Completadas” y las no confirmadas, como “Canceladas”.</span>
              </li>
            </ol>
          </div>
        </div>
          ...
          <div className="flex-1">
            ...
            <ol className="space-y-2.5 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>Presiona el botón de chat en la esquina inferior derecha para iniciar una conversación con el asistente.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Formula tu solicitud en lenguaje natural. El asistente procesará y responderá de manera automática.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Funciones disponibles: listar asesores y servicios, verificar disponibilidad, agendar, confirmar o cancelar asesorías, y consultar información institucional.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Utiliza los botones interactivos del chat para confirmar o cancelar reservas.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Todas las acciones se reflejan automáticamente en tu correo y Google Calendar.</span>
              </li>
            </ol>
          </div>
        </div>
      ...
      {/* Guía 4: Vincular Cuenta de Telegram */}
          ...
          <div className="flex-1">
            ...
            <ol className="space-y-2.5 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>Desde el panel, accede a tu perfil mediante el ícono de usuario en la esquina superior derecha.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Presiona el botón “Vincular Telegram” para iniciar la conexión.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Autoriza la apertura de Telegram y se envía el comando <code>/start</code> al bot institucional. Una vez vinculado, recibirás el mensaje de confirmación.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Desde Telegram podrás listar asesores y servicios, verificar disponibilidad, agendar, confirmar o cancelar asesorías, y consultar información institucional.</span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>Todas las acciones realizadas se sincronizan de forma inmediata con el sistema y Google Calendar.</span>
              </li>
            </ol>
          </div>
        </div>
