    ...
    <div className="overflow-hidden rounded-2xl border border-blue-200 bg-gradient-to-br from-white via-blue-50/30 to-yellow-50/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-blue-300">
      ...
      <div className="border-b border-blue-200 bg-gradient-to-r from-blue-50 to-blue-100 px-4 py-3">
        <div className="flex items-center justify-between">
          <span className={`rounded-full px-3 py-1.5 text-xs font-bold uppercase tracking-wide ${badge}`}>
            {s.status}
          </span>
        </div>
      </div>
          ...
          <div className="flex gap-2">
            ...
            {s.status === "disponible" && (
              <>
                <button
                  onClick={() => onEdit(s.id)}
                  className="flex items-center justify-center gap-2 flex-1 rounded-full bg-blue-100/80 backdrop-blur-sm border border-blue-200/50 px-4 py-2.5 text-sm font-bold text-blue-700 transition-all hover:bg-blue-200/80 hover:shadow-lg hover:-translate-y-0.5"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 flex-1 rounded-full bg-red-100/80 backdrop-blur-sm border border-red-200/50 px-4 py-2.5 text-sm font-bold text-red-700 transition-all hover:bg-red-200/80 hover:shadow-lg hover:-translate-y-0.5"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              (s.locked ? (
                ...
                <>
                  <button
                    ...
                    className="flex items-center justify-center gap-2 flex-1 rounded-full bg-green-100/80 backdrop-blur-sm border border-green-200/50 px-4 py-2.5 text-sm font-bold text-green-700 transition-all hover:bg-green-200/80 hover:shadow-lg hover:-translate-y-0.5"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
