...
export default function AdvisorStatusCards({ isCalendarConnected, monthCount, pendingCount }: Props) {
  return (
    <section className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-3">
      ...
      <MetricCard title="Este Mes" subtitle="Asesorías programadas" value={monthCount} iconType="chart" />
  ...
  return (
    <div className="rounded-2xl bg-white p-5 shadow-lg ring-1 ring-blue-100 border border-blue-100">
      <div className="mb-2 flex items-center justify-between">
        ...
        >
          <span className={["h-2 w-2 rounded-full", connected ? "bg-emerald-500" : "bg-rose-500"].join(" ")} />
